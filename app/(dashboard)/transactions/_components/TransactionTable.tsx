...
import { DataTableFacetedFilter } from "@/components/datatable/FactedFilers";
...
const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const formattedDate = date.toLocaleDateString("defaulut", {
        timeZone: "UTC",
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <p className="text-md rounded-lg bg-gray-400/5 p-2 font-medium">
...
function TransactionTable({ from, to }: Props) {
  ...
  const table = useReactTable({
    data: history.data || emptyData, // emptyData is used to prevent errors when history.data is undefined (fixes rendering issues)
    columns,
          ...
          <Button
            ...
            onClick={() => {
              const data = table.getFilteredRowModel().rows.map((row) => ({
                ...
                formattdAmount: row.original.formattedAmount,
